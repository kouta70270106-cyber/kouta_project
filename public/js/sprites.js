...
// ============================================================
//  ゴールドスライム (20w × 16h)  金色の大型スライム・コイン王
// ============================================================
function _drawGoldSlime(ctx) {
  const p = (x, y, w, h, c) => _pb(ctx, x, y, w, h, c);
  // 王冠
  p(6, 0, 8, 1, '#AA8800');
  p(5, 1, 10, 1, '#DDAA00');
  ...
  p(9, 0, 2, 2, '#DDAA00');
  p(14, 0, 2, 2, '#DDAA00');
  p(6, 0, 1, 1, '#FF4444'); // 宝石（赤）
  p(9, 0, 2, 1, '#44FF88'); // 宝石（緑）
  p(13, 0, 1, 1, '#4488FF'); // 宝石（青）
  // 体（大きい金色のしずく型）
  p(7, 2, 6, 1, '#DDAA00');
  p(4, 3, 12, 2, '#FFCC00');
  p(2, 5, 16, 4, '#FFD700');
...
// ============================================================
//  シルバースライム (20w × 16h)  銀色の大型スライム・経験値王
// ============================================================
function _drawSilverSlime(ctx) {
  const p = (x, y, w, h, c) => _pb(ctx, x, y, w, h, c);
  // 星型の角飾り
  p(9, 0, 2, 1, '#CCCCFF');
  p(8, 1, 4, 1, '#E8E8FF');
